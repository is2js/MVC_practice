...
public class NameCounter {
	...
	private SortedMap<String, Integer> counterMap;
	...
	//7. 읽기전용map만 반환할때
	public Map<String, Integer> createReadOnlyCounter() {
